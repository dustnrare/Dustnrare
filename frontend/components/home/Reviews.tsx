    ...
    <section className="py-24 bg-[var(--bg)]">
      <div className="max-w-[1360px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <div className="hidden md:block font-serif text-[6rem] leading-none text-[var(--surface)] select-none">&quot;</div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-[var(--border)]">
          {reviews.map((r, i) => (
            ...
            >
              ...
              <p className="font-serif text-[0.95rem] text-[var(--text-soft)] leading-[1.9] italic mb-8">
                {r.text}
              </p>
              ...
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <div className="text-[0.45rem] tracking-[0.3em] uppercase text-[var(--text-muted)] mt-0.5">{r.location}</div>
                </div>
        ...
        >
          <p className="text-[0.5rem] tracking-[0.3em] uppercase text-[var(--text-muted)]">
            Tag us in your fits · Share your look
          </p>
          <a
            href="https://www.instagram.com/dustnrare.in"
            target="_blank" rel="noreferrer"
            className="group inline-flex items-center gap-3 text-[0.52rem] tracking-[0.3em] uppercase font-semibold text-[var(--gold)] hover:text-[var(--gold-light)] transition-colors duration-300"
          >
