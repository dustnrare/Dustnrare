...
export default function Hero() {
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#0a0a0a] text-white">
      {/* Background Image with slow zoom logic */}
      <motion.div
      ...
      >
        ...
        />
        {/* Subtle, refined gradients just for contrast safety */}
      ...
      >
        <div className="text-[0.45rem] tracking-[0.55em] uppercase text-white/50 mb-1">
          New Delhi
        </div>
      ...
      <div className="relative z-10 h-full flex flex-col justify-center md:justify-end px-6 sm:px-10 md:px-16 pb-16 md:pb-24 max-w-[1600px] mx-auto items-center md:items-start text-center md:text-left">
        ...
        <div className="overflow-hidden w-full">
          <motion.h1
            ...
            className="font-serif text-[4.5rem] sm:text-[6rem] md:text-[clamp(6rem,11vw,10rem)] leading-[0.9] tracking-[-0.03em] font-normal pb-2 md:pb-4"
          >
            Quiet
          </motion.h1>
        </div>
        <div className="overflow-hidden mb-8 md:mb-12 w-full">
          <motion.h1
            ...
            className="font-serif text-[4.5rem] sm:text-[6rem] md:text-[clamp(6rem,11vw,10rem)] leading-[0.9] tracking-[-0.03em] font-normal italic text-white/90 pb-2 md:pb-4"
          >
            Luxury.
          </motion.h1>
        </div>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center sm:items-center gap-8 sm:gap-14"
        >
          <p className="text-[0.55rem] md:text-[0.65rem] tracking-[0.25em] md:tracking-[0.3em] uppercase text-white/60 max-w-[220px] md:max-w-[280px] leading-relaxed">
          ...
          <div className="flex gap-6 sm:gap-8 mt-2 md:mt-0">
            ...
            >
              <span className="text-[0.55rem] md:text-[0.6rem] tracking-[0.25em] uppercase font-medium text-white hover:text-[var(--gold)] transition-colors">
                Shop Men
              </span>
