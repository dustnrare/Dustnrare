...
export default function AboutPage() {
  return (
    <>
      {/* HERO */}
      <section className="pt-28 pb-16 bg-[var(--beige)] px-8">
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-2 gap-16 items-end">
          ...
          <div className="pb-2">
            <p className="text-[0.72rem] leading-[1.9] text-[var(--mid)] mb-4">
            ...
            <p className="text-[0.72rem] leading-[1.9] text-[var(--mid)]">
              We are an independent label from New Delhi. We design original pieces and
      ...
      <section className="py-20 px-8">
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-[1fr_2fr] gap-16 items-start">
          <div className="aspect-[3/4] overflow-hidden bg-[var(--beige)] sticky top-24">
            <Image
          ...
          <div className="flex flex-col gap-8 py-4">
            ...
            <p className="text-[0.7rem] leading-[1.9] text-[var(--mid)]">
              We launched in 2025 because we were tired of seeing the same fits everywhere.
      ...
      {/* VALUES */}
      <section className="py-20 px-8 bg-[var(--sage)]">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div key={v.title} className="bg-[var(--offwhite)] border border-[var(--border)] p-8">
                <div className="text-2xl text-[var(--gold)] mb-4">{v.icon}</div>
                <h3 className="font-serif text-xl text-[var(--text)] mb-3">{v.title}</h3>
                <p className="text-[0.65rem] leading-[1.8] text-[var(--mid)]">{v.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-8 bg-[var(--offwhite)]">
        <div className="max-w-[600px] mx-auto text-center">
          ...
          <p className="text-[0.68rem] leading-[1.9] text-[var(--mid)] mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            >Instagram</a>
            <a href="mailto:hello@dustnrare.com" className="btn-primary flex items-center gap-2 justify-center">
              Email Us
            </a>
          </div>
        </div>
